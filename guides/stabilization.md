...
6. If the media in the container (note: the specific media, not the folder they were found within) already have ARCH, DR, or PH numbers, link the ARCH/DR/PH records to the DM container record as children with the "Est composé de" association.  
