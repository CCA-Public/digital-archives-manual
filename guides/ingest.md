...
| Reminder: add metadata if desired | "Continue" |
| Transcribe files (OCR) | "No" |
| Perform file format identification (Submission documentation and metadata) | "Yes" |
| Select compression algorithm | "Uncompressed" |
| Select compression level | n/a (any answer can be put here) |
| Store AIP | "Yes" |
| Store AIP location | *appropriate AIP store* |
...
These have not been reviewed since the May 2019 Archivematica version upgrade. 
...
| Creator | Archive creator (should be same as agent in ArchivesSpace) |  
| Subject | n/a |  
