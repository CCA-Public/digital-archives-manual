...
At CCA, we typically do not process digital files at the item-level. Item-level metadata is instead automatically generated by Archivematica and saved into an `amdSec` in the AIP METS file for each digital file.  
