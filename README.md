...
* **[Processing email archives with ePADD](guides/email.md)**
* **[Capturing web archives with Archive-It](guides/web.md)**
...
2. Pre-processing triage and evaluation:  
   ...
   * Digital Archivist, Processing Archivist, and potentially others (Archivist, Conservation, etc.) have consultation meeting to discuss processing plan.
3. Arrangement and description:
   * Processing Archivist conducts weeding, arrangement, and preservation actions and explores contents of files in Bitcurator and CAD workstations as needed.
   ...
   * Descriptions are reviewed with Digital Archivist and approved for entry into ArchivesSpace.
   * Processing Archivist uses ArchivesSpace's bulk import description template and imports it in the database.
   * Processing Archivist creates Collection-level record (if not already present) in SCOPE.
4. Processed SIPs are ingested into Archivematica:  
   ...
   * Processing Archivist QAs ingest (automated fetching of descriptive metadata from ArchivesSpace, normalization, etc.) and stores DIPs  
...
5. Ongoing activities:  
   ...
   * Access and supporting researchers' use of SCOPE
